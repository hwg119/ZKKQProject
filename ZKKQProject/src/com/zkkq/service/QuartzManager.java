...
public class QuartzManager {
 ...
 private static String JOB_GROUP_NAME = "zkkq_job_group";
 private static String TRIGGER_GROUP_NAME = "zkkq_trigger_group";
 ...
 public static void addJob(String jobName,Job job,String time)throws SchedulerException, ParseException{
     ...
     JobDetail jobDetail = new JobDetail(jobName, JOB_GROUP_NAME, job.getClass());//任务
     CronTrigger  trigger = new CronTrigger(jobName, TRIGGER_GROUP_NAME);//触发器
 ...
 public static void addJob(String jobName,String jobGroupName,
     ...
     Scheduler sched = sf.getScheduler();
     JobDetail jobDetail = new JobDetail(jobName, jobGroupName, job.getClass());//任务
     CronTrigger  trigger = new CronTrigger(triggerName, triggerGroupName);//触发
     trigger.setCronExpression(time);//触发器时间设定
     sched.scheduleJob(jobDetail,trigger);
     if(!sched.isShutdown()){
        sched.start();
